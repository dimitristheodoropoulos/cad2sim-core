...
| **CAD2SIM-REQ-009** | Unit | `tests/unit/math/test_transform3.cpp`, `tests/unit/geometry/test_advanced_primitives.cpp` | Deterministic unit tests cover translation, Z-axis rotation, Frame3 local/world coordinate conversion, and rigid-transform round-trip; scaling is not implemented and rotation coverage is limited to the Z axis | IMPLEMENTED |
