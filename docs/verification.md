...
| **CAD2SIM-REQ-006** | Integration + Negative | `tests/integration/validation/test_geometry_validation.cpp`, `tests/fixtures/step/screw.step` | Valid imported geometry, intentionally invalid open-shell-derived solid, deterministic diagnostic output; dedicated CTest passed; full CTest 8/8 passed | VERIFIED |
| **CAD2SIM-REQ-007** | Integration | `tests/integration/properties/test_geometry_properties.cpp`, `tests/fixtures/step/screw.step` | Analytical 10x20x30 box reference for bounding box, normals, areas, lengths, volume, and centroid; representative STEP property extraction; dedicated CTest passed; full CTest 9/9 passed | VERIFIED |
