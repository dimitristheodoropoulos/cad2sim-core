...
| `CAD2SIM-REQ-009` | `include/cad2sim/math/transform3.hpp` | `src/transform3.cpp` | `tests/unit/math/test_transform3.cpp`, `tests/unit/geometry/test_advanced_primitives.cpp` | Deterministic tests cover translation, Z-axis rotation, rigid-transform round-trip, and Frame3 local/world coordinate conversion; Transform3 provides translation, Z-axis rotation, affine application, rigid-transform inversion and composition; scaling is not implemented and full requirement verification is incomplete | `IMPLEMENTED` |
